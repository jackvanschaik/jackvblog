...
[WFYI](https://www.wfyi.org/) is Indianapolis' Public Radio station. They offer some text news articles online. I was interested in Indianapolis news data for another project so I built this scraper. It could come in handy if you're interested in local news data, or just want to see how a news web scraper works. I've built several and they all work in a similar manner. I'll probably post them later!
...
library(rvest) # Used to do the actual web scraping
```
